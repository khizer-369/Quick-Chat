...
const Home = () => {
  ...
  return (
    <div className="h-screen w-full flex justify-center items-center">
      <div className="h-full md:h-[85%] w-full md:w-[95%] lg:w-[85%] backdrop-blur-xl border-2 border-gray-600 md:rounded-2xl grid grid-rows-1 grid-cols-1 md:grid-rows-1 md:grid-cols-4 overflow-hidden">
