...
export const profileUpdate = async (req, res) => {
    try {
        ...
        if (req.file) {
            ...
            updateProfile.profilePhotoUrl = profilePhotoUrl;
        }

        const updatedProfile = await User.findByIdAndUpdate(userId, updateProfile, { new: true }).populate("users").populate("requests");
